 ...
 *  for the Think AP Java chapter exercise 15.1 
 *  see below in the methods merge() and mergeSort()
 */
//http://www.greenteapress.com/thinkapjava/code/CardSoln3.java
...
class Deck 
{
    ...
    public void print() 
   {
     ...
     * It is now an object method rather than a class method, as specified in exercise 15.1
     * I prefer the static method since I find it slightly awkward to receive an object when calling an object method,
     *  so, if I were assigning this returned object to a variable, I would prefer the static method;
     *    Deck mergedDeck = merge(d1, d2);
     *    Deck mergedDeck = d1.merge(d2);
     *  out of the two above, I simply think that the first looks less awkward.
     */
     ...
     * The method is modified to accommodate the change of merge() from a class method to object method, 
     *   as by the specification of exercise 15.1
     */
